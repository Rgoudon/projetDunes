...
class MenuPrincipal(Frame):
    """ 
		...
		==========
			MonImage
			--------
					Type : classe ImageDune
					Objet de la classe ImageDune contenant l'image à afficher dans la fenetre principale
			
			LesAxes
			-------
					Type : classe GestionAxes
					objet de la classe gestionAxes contenant
